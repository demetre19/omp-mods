#!/bin/zsh
# terminal-nav setup — Apple Silicon Macs (M1/M2/M3/M4, brew prefix /opt/homebrew)
...
echo "== terminal-nav setup (Apple Silicon) =="
...
if ! grep -qF "$MARK_BEGIN" ~/.zshrc; then
  {
    ...
    echo '[ -r /opt/homebrew/opt/fzf/shell/completion.zsh ] && source /opt/homebrew/opt/fzf/shell/completion.zsh'
    echo '[ -r /opt/homebrew/opt/fzf/shell/key-bindings.zsh ] && source /opt/homebrew/opt/fzf/shell/key-bindings.zsh'
    echo ""
